...
class UsageForecastHelper():
  ...
  def insert_into_cost_lookup_table(self, target_catalog, target_schema):
    ...
    """
    self.spark.sql(f"""insert overwrite {target_catalog}.{target_schema}.sku_cost_lookup values
                ('ENTERPRISE_DLT_CORE_COMPUTE_(PHOTON)', 0.2),
                ('ENTERPRISE_DLT_PRO_COMPUTE', 0.25),
                ('ENTERPRISE_JOBS_COMPUTE_(PHOTON)', 0.2),
                ('ENTERPRISE_JOBS_SERVERLESS_COMPUTE_EUROPE_IRELAND', 0.5),
                ('ENTERPRISE_JOBS_SERVERLESS_COMPUTE_US_EAST_OHIO', 0.45),
                ...
                ('PREMIUM_SERVERLESS_SQL_COMPUTE_CANADA_CENTRAL', 0.79),
                ...
                ('ENTERPRISE_JOBS_SERVERLESS_COMPUTE_AP_SYDNEY', 0.5),
                ...
                ('PREMIUM_SQL_PRO_COMPUTE_AUSTRALIA_SYDNEY', 0.74),
                ...
                ('PREMIUM_SQL_PRO_COMPUTE_US_NEVADA', 0.55),
                ...
                ('ENTERPRISE_ALL_PURPOSE_COMPUTE_(DLT)', 0.65),
                ...
                ('PREMIUM_ALL_PURPOSE_COMPUTE_(DLT)', 0.55),
                ...
                ('PREMIUM_JOBS_SERVERLESS_COMPUTE_US_EAST_N_VIRGINIA', 0.35),
                ...
                ('PREMIUM_SERVERLESS_SQL_COMPUTE_ASIA_SOUTHEAST', 0.88),
                ('PREMIUM_SERVERLESS_SQL_COMPUTE_AUSTRALIA_EAST', 0.95),
                ...
                ('PREMIUM_SERVERLESS_SQL_COMPUTE_US_SOUTH_CENTRAL', 0.7),
                ('PREMIUM_SERVERLESS_SQL_COMPUTE_US_WEST', 0.42),
                ('PREMIUM_SERVERLESS_SQL_COMPUTE_US_WEST_2', 0.7),
                ('PREMIUM_SQL_PRO_COMPUTE_AP_SEOUL', 0.74),
                ('PREMIUM_SQL_PRO_COMPUTE_ASIA_SOUTHEAST', 0.35),
                ('PREMIUM_SQL_PRO_COMPUTE_ASIA_TOKYO', 0.78),
                ...
                ('PREMIUM_SQL_PRO_COMPUTE_CN_EAST_3', 0.61),
                ('PREMIUM_SQL_PRO_COMPUTE_CN_NORTH_3', 0.61),
                ('PREMIUM_SQL_PRO_COMPUTE_EUROPE_ENGLAND', 0.74),
                ...
                ('PREMIUM_SQL_PRO_COMPUTE_US_CENTRAL', 0.33),
                ...
                ('STANDARD_ALL_PURPOSE_COMPUTE_(DLT)', 0.4),
