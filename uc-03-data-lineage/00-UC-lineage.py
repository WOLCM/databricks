...
# MAGIC To run this demo, just select the cluster `dbdemos-uc-03-data-lineage-loca` from the dropdown menu ([open cluster configuration](https://adb-761039396517144.4.azuredatabricks.net/#setting/clusters/0818-073520-r46akn53/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fgovernance%2Fuc-03-data-lineage%2F00-UC-lineage&cid=local&uid=local">
